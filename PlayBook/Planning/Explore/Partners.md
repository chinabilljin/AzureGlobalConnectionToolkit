...
If you are looking for a marketplace in China Azure, similar to the Global Azure Marketplace, you will have to wait for a while since the marketplace for China Azure is currently under private preview – although it will be launched sometime in the near future. The China Azure Marketplace will be an online store for highly optimized and integrated applications and services ready to deploy on China Azure. The following screenshot below is a private preview of the China Azure Marketplace.

![img](https://mncplaybook.azurewebsites.net/Content/Images/planning_explore_partners.png)
...
Let's move to the next stage - [Onboarding Stage](https://github.com/Azure/AzureGlobalConnectionCenter/blob/master/PlayBook/Onboarding/Explore/Explore.md).
